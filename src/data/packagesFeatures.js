export const packages = [
  {
    title: "BASIC",
    desc: "Pentru o prezență online profesională cu tot ce ai nevoie pentru a fi găsit și contactat.",
    price: "3.000",
    features: [
    ...
    maintenance: [
      ...
      "Monitorizare panou de admin",
      "Monitorizare și curățare bază de date",
      "1 oră suport lunar (modificări de text, imagini, ajustări minore)",
      "Recomandări lunare pentru creșterea vânzărilor",
    ],
    disclaimer:
  ...
  {
    title: "STANDARD",
    desc: "Tot ce include Basic, plus instrumente pentru a gestiona solicitările clienților direct din panoul de administrare.",
    price: "5.500",
    features: [
      "TOT CE INCLUDE BASIC, PLUS: ",
      "Până la 10 pagini la alegere",
    ...
    maintenance: [
      "TOT CE INCLUDE BASIC, PLUS:",
      "Monitorizare extinsă a panoului de admin (gestionare solicitări, trimitere email-uri)",
      "Idei pentru funcționalități noi adaptate afacerii și trendurilor din lumea tehnologiei",
    ],
    disclaimer:
      "Fiecare afacere este unică, astfel că prețul final îl stabilim împreună în funcție de nevoile tale specifice.",
  },
